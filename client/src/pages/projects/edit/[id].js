      ...
      if (isAuthenticated && id) {
        try {
          ...
          if (project.status !== 'pending' && project.status !== 'pending_changes') {
            alert('Seuls les projets en attente ou en attente de modifications peuvent être modifiés.');
          ...
          setFormData({
            ...
            studentEmails: project.studentEmails ? project.studentEmails.join(', ') : '',
            links: {
          ...
          alert('Erreur lors de la récupération du projet. Redirection vers le tableau de bord.');
          router.push('/dashboard');
        }
      }
    };
